...
export default function VideoSessionPage() {
  ...
  useEffect(() => {
    ...
    const checkStatus = async () => {
      ...
      if (data?.status === "accepted") {
        router.push(`/session/video/${sessionId}`);
      }
    };
      ...
      .on(
        ...
        (payload) => {
          ...
          if (updated.status === "accepted") {
            console.log("Session accepted — redirecting to video");
            router.push(`/session/video/${sessionId}`);
          }
  ...
  useEffect(() => {
    ...
    const fetchSession = async () => {
      try {
        console.log('Fetching video session:', params.sessionId)
        ...
        console.log('Video session data:', sessionData)
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">This video session could not be found or may have expired.</p>
          <button
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          ...
          <div className="text-center py-12">
            <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-6">
              <Video className="w-8 h-8 text-purple-600 animate-pulse" />
            </div>
            ...
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              Your video call session has been created. The expert will be notified and will join shortly. 
            ...
            <div className="bg-gray-50 rounded-lg p-6 max-w-sm mx-auto">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium capitalize">Video Call</span>
                </div>
                <div className="flex justify-between">
