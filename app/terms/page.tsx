      ...
      <main className="flex-1 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 text-foreground">
            <section>
              <h2 className="text-3xl font-serif text-white mb-4">1. Agreement to Terms</h2>
            ...
            <section>
              <h2 className="text-3xl font-serif text-white mb-4">2. Use License</h2>
            ...
            <section>
              <h2 className="text-3xl font-serif text-white mb-4">3. Disclaimer</h2>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-3xl font-serif text-white mb-4">4. Limitations</h2>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-3xl font-serif text-white mb-4">5. Accuracy of Materials</h2>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-3xl font-serif text-white mb-4">6. Links</h2>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-3xl font-serif text-white mb-4">7. Modifications</h2>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-3xl font-serif text-white mb-4">8. Governing Law</h2>
              <p className="text-gray-300 leading-relaxed">
