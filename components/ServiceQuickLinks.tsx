...
const services: ServiceItem[] = [
  ...
  },
  {
    name: 'Counselling',
    href: '/counselling',
    icon: <HeartHandshake className="w-8 h-8 text-foreground" />,
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
          {services.map((service) => (
            <Link
              ...
              className="group flex flex-col items-center justify-center p-6 bg-card text-card-foreground rounded-xl shadow-sm hover:bg-secondary hover:shadow-lg hover:scale-105 active:scale-95 transition-all duration-300 cursor-pointer border border-border"
            >
